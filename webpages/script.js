// Temporary fake API for development
...
form.addEventListener("submit", async (e) => {
  ...
  try {
    ...
    const finalSignature = "SIGN-" + data.id;

    const finalOrder = {
      items: order,
      timestamp: new Date().toISOString(),
      orderSignature: finalSignature
    };
    ...
    resultBox.innerHTML = `✅ Order stored! <br> Signature: <b>${finalSignature}</b>`;
